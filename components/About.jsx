  ...
  return (
    <section className={`${styles.about_bg} about`}>
        <div className="container md:flex items-center">
            ...
            <p className='text-base md:text-lg'>I am a web developer at <span className='text-[#5869a5]'>GreenSparrow Solutions</span>, where I indulge in the art of web design, striving to deliver engaging and user-centric digital solutions.</p>
